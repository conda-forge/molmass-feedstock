...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/molmass-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/molmass-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add molmass molmass-elements-gui molmass-web
# for installing globally
pixi global install molmass molmass-elements-gui molmass-web
```
...
It is possible to list all of the versions of `molmass` available on your platform:
...
```
pixi search molmass --channel conda-forge
```
